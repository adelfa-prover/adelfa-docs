...
The full solutions are provided in [`equal-untyped.lf`](/orbi/equal-untyped.lf)
and [`equal-untyped.ath`](/orbi/equal-untyped.ath).
...
1. Reflexivity
   ```adelfa filename="equal-untyped.ath" showOutput
