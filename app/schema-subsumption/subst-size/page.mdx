...
substitution, modified from [an example in
Twelf](https://twelf.org/wiki/proving-metatheorems-proving-metatheorems-in-non-empty-contexts/).

The complete developments are provided here for reference:

- Signature: [`size.lf`](/subst-size/size.lf)
- Proof development _without_ transport:
  [`size-no-transport.ath`](/subst-size/subst-size-no-transport.ath)
- Proof development _with_ transport: [`size-transport.ath`](/subst-size/subst-size-transport.ath)
...
```adelfa filename="subst-size.ath" showOutput
...
```adelfa filename="subst-size" showOutput
...
Subgoal size-subst.2 is:
 exists D2, exists Sub-size, exists D3,
   {G |- D2 : size (lam ([c47]E1 E' c47)) Sub-size} /\
       {D3 : leq (s T-size1) Sub-size}
...
size-subst.1>> apply plus-exist-independent to H17 H18.
...
size-subst.1>> exists size-app (E1 E') (E2 E') Sub-size Sub-size1 N3 D1 D6 D.
...
==================================
exists Sub-size2, exists D3,
  {G |- size-app (E1 E') (E2 E') Sub-size Sub-size1 N3 D1 D6 D :
    size (app (E1 E') (E2 E')) Sub-size2} /\ {D3 : leq (s T-size1) Sub-size2}
...
exists D3,
  {G |- size-app (E1 E') (E2 E') Sub-size Sub-size1 N3 D1 D6 D :
    size (app (E1 E') (E2 E')) (s N3)} /\ {D3 : leq (s T-size1) (s N3)}
...
size-subst.1>> exists leq-s T-size1 N3 (D8 n1 n).
...
==================================
{G |- size-app (E1 E') (E2 E') Sub-size Sub-size1 N3 D1 D6 D :
  size (app (E1 E') (E2 E')) (s N3)} /\
    {leq-s T-size1 N3 (D8 n1 n) : leq (s T-size1) (s N3)}
...
Subgoal size-subst.2:

Vars: D:(o) -> (o) -> (o) -> (o) -> o, E1:(o) -> (o) -> o, T-size1:o, E':o
            ...
            {G |- E' : tm} =>
                exists D2, exists Sub-size, exists D3,
                  {G |- D2 : size (E E') Sub-size} /\
                      {D3 : leq T-size Sub-size}
H2:{G |- E' : tm}
H3:{G, n:tm, n1:size n (s z), n2:tm |- E1 n n2 : tm}*
H4:{G, n:tm, n1:size n (s z) |- T-size1 : nat}*
H5:
    {G, n:tm, n1:size n (s z), n3:tm, n4:size n3 (s z) |- D n1 n n3 n4 :
      size (E1 n n3) T-size1}*
...
size-subst.2>> weaken H2 with tm.
...
size-subst.2>> weaken H6 with size n5 (s z).
...
H5:
    {G, n:tm, n1:size n (s z), n3:tm, n4:size n3 (s z) |- D n1 n n3 n4 :
      size (E1 n n3) T-size1}*
H6:{G, n5:tm |- E' : tm}
H7:{G, n5:tm, n6:size n5 (s z) |- E' : tm}
...
size-subst.2>> ctxpermute H5 to G, n3:tm, n4: size n3 (s z), n:tm, n1:size n (s z).
...
H7:{G, n5:tm, n6:size n5 (s z) |- E' : tm}
H8:
    {G, n3:tm, n4:size n3 (s z), n:tm, n1:size n (s z) |- D n1 n n3 n4 :
      size (E1 n n3) T-size1}*
...
size-subst.2>> apply IH to H8 H7 with (G = G, n1:tm, n:size n1 (s z)).

Subgoal size-subst.2:

Vars: D3:(o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, Sub-size:
        (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, D2:
        (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, D:
        (o) -> (o) -> (o) -> (o) -> o, E1:(o) -> (o) -> o, T-size1:o, E':o
Nominals: n6:o, n5:o, n4:o, n3:o, n2:o, n1:o, n:o
Contexts: G{n, n1, n2, n3, n4, n5, n6}:C[]
IH:
    ctx G:C,
...
H8:
    {G, n3:tm, n4:size n3 (s z), n:tm, n1:size n (s z) |- D n1 n n3 n4 :
      size (E1 n n3) T-size1}*
H9:
    {G, n1:tm, n:size n1 (s z) |- D2 n6 n5 n4 n3 n2 n1 n :
      size (E1 E' n1) (Sub-size n6 n5 n4 n3 n2 n1 n)} /\
        {D3 n6 n5 n4 n3 n2 n1 n : leq T-size1 (Sub-size n6 n5 n4 n3 n2 n1 n)}
...
H10:
    {G, n1:tm, n:size n1 (s z) |- D2 n6 n5 n4 n3 n2 n1 n :
      size (E1 E' n1) (Sub-size n6 n5 n4 n3 n2 n1 n)}
H11:{D3 n6 n5 n4 n3 n2 n1 n : leq T-size1 (Sub-size n6 n5 n4 n3 n2 n1 n)}
...
size-subst.2>> prune H10.

Subgoal size-subst.2:

Vars: D3:(o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, Sub-size:
        (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, D2:
        (o) -> (o) -> o, D:(o) -> (o) -> (o) -> (o) -> o, E1:(o) -> (o) -> o,
        T-size1:o, E':o
Nominals: n6:o, n5:o, n4:o, n3:o, n2:o, n1:o, n:o
Contexts: G{n, n1, n2, n3, n4, n5, n6}:C[]
IH:
...
size-subst.2>> assert {G, n1:tm, n:size n1 (s z) |- Sub-size n6 n5 n4 n3 n2 n1 n : nat}.
...
H10:
    {G, n1:tm, n:size n1 (s z) |- D2 n1 n :
      size (E1 E' n1) (Sub-size n6 n5 n4 n3 n2 n1 n)}
H11:{D3 n6 n5 n4 n3 n2 n1 n : leq T-size1 (Sub-size n6 n5 n4 n3 n2 n1 n)}
H12:{G, n1:tm, n:size n1 (s z) |- Sub-size n6 n5 n4 n3 n2 n1 n : nat}
...
size-subst.2>> prune H12.

Subgoal size-subst.2:

Vars: D3:(o) -> (o) -> (o) -> (o) -> (o) -> (o) -> (o) -> o, Sub-size:o, D2:
        (o) -> (o) -> o, D:(o) -> (o) -> (o) -> (o) -> o, E1:(o) -> (o) -> o,
        T-size1:o, E':o
Nominals: n6:o, n5:o, n4:o, n3:o, n2:o, n1:o, n:o
Contexts: G{n, n1, n2, n3, n4, n5, n6}:C[]
...
H8:
    {G, n3:tm, n4:size n3 (s z), n:tm, n1:size n (s z) |- D n1 n n3 n4 :
      size (E1 n n3) T-size1}*
H10:{G, n1:tm, n:size n1 (s z) |- D2 n1 n : size (E1 E' n1) Sub-size}
H11:{D3 n6 n5 n4 n3 n2 n1 n : leq T-size1 Sub-size}
H12:{G, n1:tm, n:size n1 (s z) |- Sub-size : nat}
...
H11:{D3 n6 n5 n4 n3 n2 n1 n : leq T-size1 Sub-size}
H12:{G, n1:tm, n:size n1 (s z) |- Sub-size : nat}
H13:{G, n1:size E' (s z), n2:tm |- E1 E' n2 : tm}
...
size-subst.2>> ctxpermute H13 to G, n2:tm, n1: size E' (s z).
...
H12:{G, n1:tm, n:size n1 (s z) |- Sub-size : nat}
H13:{G, n1:size E' (s z), n2:tm |- E1 E' n2 : tm}
H14:{G, n2:tm, n1:size E' (s z) |- E1 E' n2 : tm}
...
size-subst.2>> exists size-lam ([x] E1 E' x) Sub-size D2.
...
==================================
exists Sub-size1, exists D3,
  {G |- size-lam ([x]E1 E' x) Sub-size D2 :
    size (lam ([c47]E1 E' c47)) Sub-size1} /\
      {D3 : leq (s T-size1) Sub-size1}
...
size-subst.2>> exists (s Sub-size).
...
exists D3,
  {G |- size-lam ([x]E1 E' x) Sub-size D2 :
    size (lam ([c47]E1 E' c47)) (s Sub-size)} /\
      {D3 : leq (s T-size1) (s Sub-size)}
...
size-subst.2>> exists leq-s T-size1 Sub-size (D3 n6 n5 n4 n3 n2 n1 n).
...
{G |- size-lam ([x]E1 E' x) Sub-size D2 :
  size (lam ([c47]E1 E' c47)) (s Sub-size)} /\
    {leq-s T-size1 Sub-size (D3 n6 n5 n4 n3 n2 n1 n) :
      leq (s T-size1) (s Sub-size)}
...
size-subst.3>> apply tm-has-size to H2.

Subgoal size-subst.3:

Vars: D:(o) -> (o) -> o, N:(o) -> (o) -> o, E':o
Nominals: n1:o, n:o
Contexts: G{n, n1}:C[]
IH:
    ctx G:C,
...
size-subst.3>> prune H3.

Subgoal size-subst.3:

Vars: D:o, N:(o) -> (o) -> o, E':o
Nominals: n1:o, n:o
Contexts: G{n, n1}:C[]
IH:
    ctx G:C,
...
size-subst.3>> assert {G |- N n1 n : nat}.
...
==================================
exists Sub-size, exists D3,
  {G |- D : size E' Sub-size} /\ {D3 : leq (s z) Sub-size}

Subgoal size-subst.4 is:
 exists D2, exists Sub-size, exists D3,
   {G |- D2 : size n2 Sub-size} /\ {D3 : leq (s z) Sub-size}

size-subst.3>> exists N.
...
==================================
exists D3, {G |- D : size E' N} /\ {D3 : leq (s z) N}

Subgoal size-subst.4 is:
 exists D2, exists Sub-size, exists D3,
   {G |- D2 : size n2 Sub-size} /\ {D3 : leq (s z) Sub-size}

size-subst.3>> apply size-at-least-one to H3.

Subgoal size-subst.3:

Vars: D':(o) -> (o) -> o, D:o, N:o, E':o
Nominals: n1:o, n:o
Contexts: G{n, n1}:C[]
IH:
    ctx G:C,
...
Subgoal size-subst.4:

Vars: E':(o) -> (o) -> o
Nominals: n3:o, n2:o, n1:o, n:o
Contexts: G{n, n1}:C[(n2:tm, n3:size n2 (s z))]
IH:
    ctx G:C,
      forall E', forall E, forall T-size, forall D1,
        {G |- [x][dx]D1 x dx : {x:tm}{dx:size x (s z)}size (E x) T-size}* =>
...
==================================
exists Sub-size, exists D3,
  {G |- n3 : size n2 Sub-size} /\ {D3 : leq (s z) Sub-size}

size-subst.4>> exists (s z).
...
==================================
exists D3, {G |- n3 : size n2 (s z)} /\ {D3 : leq (s z) (s z)}

size-subst.4>> exists leq-s z z (leq-z z).
...
==================================
{G |- n3 : size n2 (s z)} /\ {leq-s z z (leq-z z) : leq (s z) (s z)}
...
schema `C`. While this works, this approach results in a more complex proof
structure. 
 
When using library lemmas with this approach, the relevant assumptions must
first be shown to be independent of the context variable via the relevant
independence lemma. 
 
For example, invoking the monotonicity property discussed earlier is
accomplished with three uses of the `apply` tactic.
...
property to be utilized directly, with only one use of the `apply` tactic.
