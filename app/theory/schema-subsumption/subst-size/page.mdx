...
- Signature: [`size.lf{:plain}`](/subst-size/size.lf)
- Proof development _without_ transport:
  [`size-no-transport.ath{:plain}`](/subst-size/subst-size-no-transport.ath)
- Proof development _with_ transport:
  [`size-transport.ath{:plain}`](/subst-size/subst-size-transport.ath)
