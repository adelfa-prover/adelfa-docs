...
- Signature: [`size.lf{:plain}`](/size/size.lf)
- Proof development _without_ transport:
  [`size-no-transport.ath{:plain}`](/size/size-no-transport.ath)
- Proof development _with_ transport: [`size-transport.ath{:plain}`](/size/size-transport.ath)
