...
install this [pre-release version](/adelfa-transport.tar) which implements
the transport rule.
...
Contexts"](https://dl.acm.org/doi/10.1145/3756907.3756919) but aims to be as
self-contained as possible. We suggest reading the following examples in the
order presented below as they are intended to build on each other.
...
3. [ORBI](/schema-subsumption/orbi) completes a standardized benchmark for
   ...
   subsumption permits.
4. [POPLmark](/schema-subsumption/poplmark) utilizes schema subsumption across
